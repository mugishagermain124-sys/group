...
const images = [
  "king1.jpg","king2.jpg","king3.jpg","culture1.jpg","culture2.jpg",
  "culture3.jpg","heritage1.jpg","heritage2.jpg","heritage3.jpg","history1.jpg"
];
...
function getTileStyle(tile) {
  ...
  return {
    backgroundImage: `url(${getImagePath(images[currentLevel.value])})`,
